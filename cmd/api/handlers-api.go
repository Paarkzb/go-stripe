...
func (app *application) ResetPassword(w http.ResponseWriter, r *http.Request) {
	...
	enctyptor := encryption.Encryption{
		Key: []byte(app.config.secretkey),
	}

	realEmail, err := enctyptor.Decrypt(payload.Email)
	if err != nil {
		app.badRequest(w, r, err)
		return
	}
...
func (app *application) AllSales(w http.ResponseWriter, r *http.Request) {
	...
	allSales, lastPage, totalRecords, err := app.DB.GetAllOrdersPaginated(false, payload.PageSize, payload.CurrentPage)
	if err != nil {
		app.badRequest(w, r, err)
		return
	}
...
func (app *application) AllSubscriptions(w http.ResponseWriter, r *http.Request) {
	...
	allSubscriptions, lastPage, totalRecords, err := app.DB.GetAllOrdersPaginated(true, payload.PageSize, payload.CurrentPage)
	if err != nil {
		app.badRequest(w, r, err)
		return
	}
